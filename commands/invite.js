...
module.exports.run = async (bot, message, args, ops, PREFIX) => {
 ...
 const embed = new Discord.RichEmbed()
    ...
    .setDescription("[Invite me](https://discord.com/api/oauth2/authorize?client_id=723558381570359327&permissions=8&scope=bot) | [Vote me]() | [Support server](https://discord.gg/Q2At3nb)")    
